  ...
  return (
    <div className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-sm">
      ...
      {loading ? (
        ...
        <div className="flex h-[180px] items-center rounded-lg border border-[var(--destructive-border)] bg-[var(--destructive-soft)] px-4">
          <p className="text-sm text-[var(--destructive-foreground)]">{error} Please try refreshing.</p>
        </div>
      ) : (
        <>
