  ...
  return (
    <div className="h-full rounded-xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-sm">
              ...
              <li key={goal.id} className="relative">
                ...
                <div className="flex justify-between items-center text-sm mb-1">
                  <div className="flex flex-col gap-0.5">
                    ...
                    {completed && (
                      <span className="text-xs font-medium text-[var(--success-foreground)]">
                        {completionLabel}
                      </span>
                    )}
                  </div>
                    ...
                    {isConfirming ? (
                      <span className="flex items-center gap-1 text-xs">
                        ...
                        <button
                          ...
                          disabled={isDeleting}
                          className="text-[var(--destructive-foreground)] hover:opacity-80 font-semibold transition-colors disabled:opacity-50"
                      ...
                      <button
                        ...
                        disabled={isDeleting}
                        className="text-[var(--muted-foreground)] hover:text-[var(--destructive-foreground)] transition-colors disabled:opacity-50"
      ...
      <form onSubmit={handleCreate} className="mt-6 space-y-3 border-t border-[var(--border)] pt-4">
        ...
        {createError && (
          <p className="text-sm text-[var(--destructive-foreground)]">{createError}</p>
        )}
      </form>
    </div>
  );
