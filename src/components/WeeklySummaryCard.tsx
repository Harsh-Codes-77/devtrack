    ...
    <div className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-sm">
      ...
      {!isCollapsed &&
        (loading ? (
          ...
          <div className="mt-4 rounded-lg border border-[var(--destructive-border)] bg-[var(--destructive-soft)] p-4 text-sm text-[var(--destructive-foreground)]">
            {error}
          </div>
        ) : summary ? (
            ...
            <div className="flex items-center justify-between rounded-lg bg-[var(--control)] p-4">
              ...
              <div className="flex items-center gap-2">
                ...
                {summary.commits.trend === "down" && (
                  <span className="text-sm font-medium text-[var(--destructive-foreground)]">
