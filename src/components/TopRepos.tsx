      ...
      <>
        ...
        <ul className="space-y-3">
          {sortedRepos.map((repo, idx) => {
            ...
            const badgeClass =
              health?.grade === "green"
                ? "bg-[var(--success-soft)] text-[var(--success-foreground)] border border-[var(--success-border)]"
                : health?.grade === "yellow"
                  ? "bg-[var(--warning-soft)] text-[var(--warning-foreground)] border border-[var(--warning-border)]"
                  : "bg-[var(--destructive-soft)] text-[var(--destructive-foreground)] border border-[var(--destructive-border)]";
