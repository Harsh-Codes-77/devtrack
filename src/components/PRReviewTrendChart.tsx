    ...
    <div className="flex h-full flex-col rounded-xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-sm">
      ...
      {loading ? (
        ...
        <div className="flex h-[360px] items-center justify-center">
          <div className="max-w-sm rounded-lg border border-[var(--destructive-border)] bg-[var(--destructive-soft)] p-5 text-center">
            <p className="text-sm text-[var(--destructive-foreground)]">{error}</p>
            <button
              type="button"
              onClick={fetchTrend}
              className="mt-4 rounded-md border border-[var(--destructive-border)] px-3 py-1.5 text-xs font-medium text-[var(--destructive-foreground)] transition-colors hover:bg-[var(--destructive-soft)]"
            >
              Try again
            </button>
          </div>
